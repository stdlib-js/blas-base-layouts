...
```javascript
layouts = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-layouts@v0.0.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-layouts@v0.0.2-umd/browser.js"></script>
```
