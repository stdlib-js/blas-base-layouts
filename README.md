...
```javascript
import layouts from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-layouts@v0.0.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { enum } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-layouts@v0.0.3-deno/mod.js';
```
